...
class ETL:
    ...
    def execute(self,args,logger):
        ...
        net_file, prov_path = network2.extract_import(args.zip_path)
        ...
        rate_path,provider_path = scrubbing.scrub_import(net_file, prov_path,args.provider_detail, self,logger)
